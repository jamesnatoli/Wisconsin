...
// Tue Jul  9 16:45:22 2024 by ROOT version 6.30/06
// from TTree Events/Events
// found on file: /hdfs/store/user/jnatoli/NanoTauAnalysis/samples/nano/Wto3pi_2018/Wto3pi_2018_step1/DYJetsToLL_LHEFilterPtZ-50To100_MatchEWPDG20_TuneCP5_13TeV-amcatnloFXFX-pythia8/RunIISummer20UL18NanoAODv9-106X_upgrade2018_realistic_v16_L1v1-v1/NANOAODSIM/046EE332-FA31-2847-AA9C-6F06AD8EDE2F_Wto3pi_2018_step1_0.root
//////////////////////////////////////////////////////////

#ifndef stitchStudy_h
#define stitchStudy_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         Tau_energyScale[8];   //[nTau]
   Float_t         Tau_energyScale_DM0_up[8];   //[nTau]
   Float_t         Tau_energyScale_DM0_down[8];   //[nTau]
   Float_t         Tau_energyScale_DM1_up[8];   //[nTau]
   Float_t         Tau_energyScale_DM1_down[8];   //[nTau]
   Float_t         Tau_energyScale_DM2_up[8];   //[nTau]
   Float_t         Tau_energyScale_DM2_down[8];   //[nTau]
   Float_t         Tau_energyScale_DM10_up[8];   //[nTau]
   Float_t         Tau_energyScale_DM10_down[8];   //[nTau]
   Float_t         Tau_energyScale_DM11_up[8];   //[nTau]
   Float_t         Tau_energyScale_DM11_down[8];   //[nTau]
   UInt_t          nPionTrack;
   Float_t         PionTrack_pt[4];   //[nPionTrack]
   Float_t         PionTrack_eta[4];   //[nPionTrack]
   Float_t         PionTrack_phi[4];   //[nPionTrack]
   Float_t         PionTrack_iso[4];   //[nPionTrack]
...
#ifdef stitchStudy_cxx
stitchStudy::stitchStudy(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/hdfs/store/user/jnatoli/NanoTauAnalysis/samples/nano/Wto3pi_2018/Wto3pi_2018_step1/DYJetsToLL_LHEFilterPtZ-50To100_MatchEWPDG20_TuneCP5_13TeV-amcatnloFXFX-pythia8/RunIISummer20UL18NanoAODv9-106X_upgrade2018_realistic_v16_L1v1-v1/NANOAODSIM/046EE332-FA31-2847-AA9C-6F06AD8EDE2F_Wto3pi_2018_step1_0.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/hdfs/store/user/jnatoli/NanoTauAnalysis/samples/nano/Wto3pi_2018/Wto3pi_2018_step1/DYJetsToLL_LHEFilterPtZ-50To100_MatchEWPDG20_TuneCP5_13TeV-amcatnloFXFX-pythia8/RunIISummer20UL18NanoAODv9-106X_upgrade2018_realistic_v16_L1v1-v1/NANOAODSIM/046EE332-FA31-2847-AA9C-6F06AD8EDE2F_Wto3pi_2018_step1_0.root");
      }
...
stitchStudy::~stitchStudy()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t stitchStudy::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t stitchStudy::LoadTree(Long64_t entry)
{
...
void stitchStudy::Init(TTree *tree)
{
...
void stitchStudy::Show(Long64_t entry)
{
...
Int_t stitchStudy::Cut(Long64_t entry)
{
